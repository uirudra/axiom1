...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative flex flex-col items-center justify-center overflow-hidden grid-bg"
    >
      <BackgroundPaths />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 pt-32 pb-0">
        <motion.div
        ...
        <div className="hero-cta opacity-0 flex flex-col sm:flex-row gap-4 items-center mb-0">
          <Link
            href="/markets"
      ...
      {/* Spline 3D scene — flows below the text, blended into the page */}
      <div className="relative w-full max-w-5xl h-[520px] lg:h-[640px] mt-[-2rem]">
        <SplineScene
        ...
        <div
          ...
          style={{
            background: `
              linear-gradient(to bottom, #030308 0%, transparent 16%, transparent 80%, #030308 100%),
              linear-gradient(to right,  #030308 0%, transparent 12%, transparent 88%, #030308 100%)
            `,
          }}
        />
      </div>
      ...
      <motion.div
        ...
        className="relative z-10 flex flex-col items-center gap-2 pb-10 -mt-8"
      >
